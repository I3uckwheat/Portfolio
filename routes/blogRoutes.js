...
router.post('/new', blogController.seperateTags, blogController.createPost); // Adds new blog to DB
router.post('/new/:id', blogController.seperateTags, blogController.updatePost); // updates existing post
